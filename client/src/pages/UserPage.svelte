...
>
  <div class="container w-1/4 p-2 sidebar-container md:flex items-start justify-center">
    <Sidebar>
      <SidebarWrapper divClass="bg-white dark:bg-inherit">
        <SidebarGroup>
          <SidebarItem label="Home" activeClass="dark:text-white ">
  ...
  <div class="container w-1/4 p-2 sidebar-container md:flex items-start justify-end">
    <Sidebar>
      <SidebarWrapper divClass="bg-white dark:bg-inherit flex justify-end">
        <SidebarGroup>
          <SidebarItem label="Home" activeClass="dark:text-white ">
            <svelte:fragment slot="icon">
              <svg
